...
//   setTimeout(() => {
//     if(percentage) return callback(temperature);
...
uppercase('vinicius', console.log)
...
const element = (pokemon) => pokemon.name === 'Squirtle';

getPokemonDetails(element, (error, message) => {
  if(error) {
    console.log(error);
  } else {
    console.log(message);
