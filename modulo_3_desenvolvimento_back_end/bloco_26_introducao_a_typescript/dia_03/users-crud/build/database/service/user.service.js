...
const jwtConfig_1 = require("../middlewares/jwtConfig");
...
function create(user) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const payload = yield userModel.create(user);
        const token = jsonwebtoken_1.default.sign({ payload }, jwtConfig_1.secret, jwtConfig_1.config);
...
function update(id, user, token) {
    return __awaiter(this, void 0, void 0, function* () {
        const { payload } = jsonwebtoken_1.default.verify(token, jwtConfig_1.secret);
        if (payload.id !== id) {
